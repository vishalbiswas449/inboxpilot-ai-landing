...
const AboutSection = () => {
  return (
    <section id="about" className="py-20 relative overflow-hidden">
      {/* Background elements */}
      <div className="absolute top-0 right-0 w-1/3 h-1/3 bg-light-green/10 rounded-full filter blur-[100px] -z-10"></div>
      <div className="absolute bottom-0 left-0 w-1/3 h-1/3 bg-army-green/10 rounded-full filter blur-[100px] -z-10"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2 animate-scale-up">
            <div className="glass-card rounded-xl p-6 relative">
              <div className="absolute -top-5 -left-5 w-12 h-12 rounded-full green-gradient flex items-center justify-center text-xl font-bold text-white">
                AI
              </div>
              <img 
              ...
              <div className="mt-6 space-y-4">
                <div className="glass-card-dark rounded-lg p-4 text-sm text-white">
